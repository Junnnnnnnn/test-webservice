 ...
 * 
 */
@WebServiceClient(name = "BookServiceService", targetNamespace = "http://controller.ws.zz.com/", wsdlLocation = "http://localhost:9999/server?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BOOKSERVICESERVICE_QNAME = new QName("http://controller.ws.zz.com/", "BookServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/server?wsdl");
    ...
    public BookService getBookServicePort() {
        return super.getPort(new QName("http://controller.ws.zz.com/", "BookServicePort"), BookService.class);
    }
    ...
    public BookService getBookServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://controller.ws.zz.com/", "BookServicePort"), BookService.class, features);
    }
